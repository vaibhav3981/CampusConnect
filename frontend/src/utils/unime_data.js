...
export const academicCalendar = {
    ...
    semesters: [
      {
        ...
        lectures: { start: '2025-09-15', end: '2025-12-20' },
        exams:    { start: '2026-01-07', end: '2026-02-28' },
        color: '#f59e0b',
      },
      {
        id: 'spring',
        label: 'Spring Semester',
        lectures: { start: '2026-02-17', end: '2026-05-31' },
        exams:    { start: '2026-06-01', end: '2026-07-31' },
        color: '#3b82f6',
      },
    ],
    extraSessions: [
      { label: 'Extraordinary Exam Session', start: '2026-11-01', end: '2026-11-30' },
      { label: 'Summer Break',               start: '2026-08-01', end: '2026-09-14' },
    ],
    publicHolidays: [
      { label: 'All Saints Day',        date: '2025-11-01' },
      { label: 'Immaculate Conception', date: '2025-12-08' },
      { label: 'Christmas Break',       start: '2025-12-21', end: '2026-01-06' },
      { label: 'Easter Break',          start: '2026-04-02', end: '2026-04-07' },
      { label: 'Liberation Day',        date: '2026-04-25' },
      { label: 'Labour Day',            date: '2026-05-01' },
      { label: 'Republic Day',          date: '2026-06-02' },
    ],
  }
  ...
  export const programmes = {
    ...
    // 5-6 year combined Bachelor + Master programmes
    singleCycle: [
  ...
  export const serviceLinks = [
    { id: 'esse3',     name: 'ESSE3 Portal',      description: 'Book exams, check grades, manage your academic career',       url: 'https://unime.esse3.cineca.it/', icon: 'GraduationCap',   color: '#3b82f6' },
    { id: 'email',     name: 'Student Email',     description: 'codicefiscale@studenti.unime.it — Outlook',                  url: 'https://outlook.office.com/',    icon: 'Mail',            color: '#06b6d4' },
    { id: 'ersu_app',  name: 'ERSU Messina App',  description: 'Canteen balance, meal booking, residence info',              url: 'https://www.ersumessina.it/',    icon: 'UtensilsCrossed', color: '#f59e0b' },
    { id: 'sba',       name: 'SBA Library',       description: 'Book study rooms, access IEEE, Scopus, Web of Science',      url: 'https://sba.unime.it/',          icon: 'BookOpen',        color: '#8b5cf6' },
    { id: 'moodle',    name: 'Moodle (e-Learning)',description: 'Course materials, assignments, professor uploads',           url: 'https://moodle.unime.it/',       icon: 'Monitor',         color: '#10b981' },
    { id: 'esn',       name: 'ESN Messina',        description: 'Erasmus student network — events, accommodation, buddies',   url: 'https://esnmessina.it/',         icon: 'Globe',           color: '#f43f5e' },
    { id: 'transport', name: 'ATM Bus Pass',       description: '€30/year student discounted pass — request via ESSE3',      url: 'https://unime.esse3.cineca.it/', icon: 'Bus',             color: '#f97316' },
    { id: 'apply',     name: 'Apply to UniME',    description: 'Applications for international students',                    url: 'https://unime.gomovein.com/',    icon: 'FileText',        color: '#ec4899' },
  ]
  ...
  export const programmeOptions = {
    ...
    // Single-cycle: 5-6 year combined programmes
    singleCycle: [
      'Law',
      'Medicine & Surgery',
      'Pharmacy',
